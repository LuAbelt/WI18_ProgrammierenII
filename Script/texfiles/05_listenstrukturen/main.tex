...
\begin{document}
	...
	\input{texfiles/\jobname/overview}
	
	\outlineFrame{Arrays}
	\input{texfiles/\jobname/arrays}
	
	\outlineFrame{Linked Lists}
	\input{texfiles/\jobname/llist}
	
	\outlineFrame{Double Linked Lists}
	\input{texfiles/\jobname/dllist}
	
	\outlineFrame{Aufgaben I}
	\input{texfiles/\jobname/excercises1}
	
	\outlineFrame{Stacks}
	\input{texfiles/\jobname/stacks}
	
	\outlineFrame{Queues}
	\input{texfiles/\jobname/queues}
	
	\outlineFrame{Trees}
	\input{texfiles/\jobname/trees}
    
	\outlineFrame{Aufgaben II}
	\input{texfiles/\jobname/excercises2}
