...
\begin{itemize}
    \item Laufzeitkomplexität: \visible<2-|handout:0>{$\tau(N)=3$}
    \item<3-> Speicherkomplexität(In Byte): \visible<4-|handout:0>{$\tau(N)=12$}
\end{itemize}
\end{frame}
...
\begin{itemize}
    \item Laufzeitkomplexität: \visible<2-|handout:0>{$\tau(N)=6$}
    \item<3-> Speicherkomplexität(In Byte): \visible<4-|handout:0>{$\tau(N)=8$}
\end{itemize}
\end{frame}
...
\visible<+-|handout:0>{$ \tau(n) = 1 + 2\cdot(n+1) +  2n + 1 $}

\visible<+-|handout:0>{$ \tau(n) = 1+ 2n + 2 + 2n +1 $}
