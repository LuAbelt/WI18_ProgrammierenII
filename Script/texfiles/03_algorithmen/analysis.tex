...
\begin{itemize}
    \item Laufzeitkomplexität: \visible<2->{$\tau(N)=3$}
    \item<3-> Speicherkomplexität(In Byte): \visible<4->{$\tau(N)=12$}
\end{itemize}
\end{frame}
...
\begin{itemize}
    \item Laufzeitkomplexität: \visible<2->{$\tau(N)=6$}
    \item<3-> Speicherkomplexität(In Byte): \visible<4->{$\tau(N)=8$}
\end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Beispiele für Komplexität}{Kein Wachstum}
\lstset{style=java}
\begin{lstlisting}
...
\begin{frame}[fragile]{Beispiele für Komplexität}{$N$-log $N$-Wachstum}
\lstset{style=java}
\begin{lstlisting}
...
\begin{frame}{Beispiele für Komplexität}{Exponentielles Wachstum}
\begin{itemize}
