...
\begin{itemize}
    \item Laufzeitkomplexität: \visible<3->{$\tau(N)=3$}
    \item<4-> Speicherkomplexität(In Byte): \visible<5->{$\tau(N)=12$}
\end{itemize}
\end{frame}
...
\begin{itemize}
    \item Laufzeitkomplexität: \visible<3->{$\tau(N)=6$}
    \item<4-> Speicherkomplexität(In Byte): \visible<5->{$\tau(N)=8$}
\end{itemize}
\end{frame}
...
\visible<+->{$ \tau(n) = 1 + 2\cdot(n+1) +  3n + 1 $}

\visible<+->{$ \tau(n) = 1+ 2n + 2 + 3n +1 $}
