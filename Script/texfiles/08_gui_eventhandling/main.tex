...
\begin{document}
    ...
    \outlineFrame{Eventlistener}
    \input{texfiles/\jobname/listener}
    
    \outlineFrame{Adapter}
    \input{texfiles/\jobname/adapter}
    
    \outlineFrame{Model-View-Controller}
    \input{texfiles/\jobname/mvc}
